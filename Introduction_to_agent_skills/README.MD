...
The first thing to try is the agent skills verifier command. Installation steps vary by operating system, but using **uv synk** is the easiest way to get it set up quickly.
